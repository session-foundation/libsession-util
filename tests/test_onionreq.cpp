...
TEST_CASE("Onion request encryption", "[encryption][onionreq]") {
    ...
    auto A = "bbdfc83022d0aff084a6f0c529a93d1c4d728bf7e41199afed0e01ae70d20540"_hex_b;
    auto B = "caea52c5b0c316d85ffb53ea536826618b13dee40685f166f632653114526a78"_hex_b;
    auto b = "8fcd8ad3a15c76f76f1c56dff0c529999f8c59b4acda79e05666e54d5727dca1"_hex_b;
    ...
    auto enc_xchacha20 =
            ...
            "7d1638d765db75de02b032"_hex_b;
    auto enc_xchacha20_broken1 =
            "9e1a3abe60eff3ea5c23556cc7e225b6f94355315f7281f66ecf4dbb06e7899a52b863e03cde3b28"
            "7d1638d765db75de02b033"_hex_b;
    ...
    CHECK(to_string(e.decrypt_aesgcm(enc_gcm, x25519_pubkey::from_bytes(A))) == "Hello world");
    CHECK(to_string(e.decrypt_xchacha20(enc_xchacha20, x25519_pubkey::from_bytes(A))) ==
          "Hello world");
...
TEST_CASE("Onion request parser", "[onionreq][parser]") {
    ...
    auto A = "8167e97672005c669a48858c69895f395ca235219ac3f7a4210022b1f910e652"_hex_b;
    auto a = "d2ee09e1a557a077d385fcb69a11ffb6909ecdcc8348def3e0e4172c8a1431c1"_hex_b;
    auto B = "8388de69bc0d4b6196133233ad9a46ba0473474bc67718aad96a3a33c257f726"_hex_b;
    auto b = "2f4d1c0d28e137777ec0a316e9f4f763e3e66662a6c51994c6315c9ef34b6deb"_hex_b;
    ...
    auto enc_gcm =
            ...
            "6637613432313030323262316639313065363532227d"_hex_b;
    auto enc_xchacha20 =
            ...
            "33393563613233353231396163336637613432313030323262316639313065363532227d"_hex_b;
    ...
    CHECK(to_string(e.decrypt_aesgcm(aes_reply, x25519_pubkey::from_bytes(B))) == "Goodbye world");
