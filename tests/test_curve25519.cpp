...
TEST_CASE("X25519 conversion", "[curve25519][to curve25519 pubkey]") {
    ...
    auto x_pk1 = curve25519::to_curve25519_pubkey(to_span(ed_pk1));
    auto x_pk2 = curve25519::to_curve25519_pubkey(to_span(ed_pk2));
...
TEST_CASE("X25519 conversion", "[curve25519][to curve25519 seckey]") {
    ...
    auto x_sk1 = curve25519::to_curve25519_seckey(to_span(ed_sk1));
    auto x_sk2 = curve25519::to_curve25519_seckey(to_span(ed_sk2));
